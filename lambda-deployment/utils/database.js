// Database utility module - Fixed imports
 ...
 */
async function getById(table, id, condition = '') {
    const whereClause = condition ? `id = ? AND ${condition}` : 'id = ?';
 ...
 */
async function getAll(table, condition = '', params = [], orderBy = 'id') {
